...
public enum Vi6Styles {
	TOOL_LORE(TextStyle.build(TagResolver.standard(),
			TagResolver.resolver("lore", Tag.styling(
					b -> b.color(NamedTextColor.LIGHT_PURPLE).decoration(TextDecoration.ITALIC, State.NOT_SET))),
