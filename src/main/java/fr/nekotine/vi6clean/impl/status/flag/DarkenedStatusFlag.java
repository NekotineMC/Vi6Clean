...
public class DarkenedStatusFlag implements StatusFlag {
	...
	private static final PotionEffect darknessEffect = new PotionEffect(PotionEffectType.DARKNESS, -1, 0, false, false,
			true);
	// private static final PotionEffect nightVisionEffect = new
	// PotionEffect(PotionEffectType.NIGHT_VISION, -1, 0, false, false, true);
