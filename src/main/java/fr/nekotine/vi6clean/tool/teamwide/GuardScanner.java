package fr.nekotine.vi6clean.tool.teamwide;
...
public class GuardScanner {
	...
	public void startScanning() {
		task = Bukkit.getScheduler().runTaskTimer(Ioc.resolve(JavaPlugin.class), this::scan, 0,
				Tick.tick().fromDuration(scanDelay));
	}
